...
import { ChevronDown, ChevronUp, ChevronLeft, ChevronRight, History, LogOut } from 'lucide-react'
        ...
        {isAdmin ? (
          ...
          <>
            ...
            <button className="nav-group-btn" onClick={() => {
              ...
              <span className="nav-group-left"><History size={15} /> <span className="label">Riwayat</span></span>
