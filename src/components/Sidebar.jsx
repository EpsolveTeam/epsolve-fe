...
const MenuIcon = () => (
  ...
  >
    <path
      d="M3.16667 0.5H9.83333M1.83333 3.16667H11.1667M1.83333 5.83333H11.1667C11.903 5.83333 12.5 6.43029 12.5 7.16667V12.5C12.5 13.2364 11.903 13.8333 11.1667 13.8333H1.83333C1.09695 13.8333 0.5 13.2364 0.5 12.5V7.16667C0.5 6.43029 1.09695 5.83333 1.83333 5.83333Z"
      stroke="currentColor"
      strokeLinecap="round"
...
const ChatIcon = () => (
  ...
  >
    <path
      d="M6.5 3.16667V7.16667M4.5 5.16667H8.5M12.5 8.5C12.5 8.85362 12.3595 9.19276 12.1095 9.44281C11.8594 9.69286 11.5203 9.83333 11.1667 9.83333H3.16667L0.5 12.5V1.83333C0.5 1.47971 0.640476 1.14057 0.890524 0.890524C1.14057 0.640476 1.47971 0.5 1.83333 0.5H11.1667C11.5203 0.5 11.8594 0.640476 12.1095 0.890524C12.3595 1.14057 12.5 1.47971 12.5 1.83333V8.5Z"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
...
export default function Sidebar({
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (
        openMenuId &&
        !e.target.closest(".nav-history-dropdown") &&
        !e.target.closest(".nav-history-menu-btn")
      ) {
        setOpenMenuId(null);
      }
    };
              ...
              {history.map((h) => (
                <div key={h.id} className="nav-history-item-wrapper">
                  <button
                    ...
                    onClick={() => {
                      setPage("chat");
                      setChatSession({ session_id: h.id, title: h.title });
                      setOpenMenuId(null);
                    }}
                  >
                    {h.title}
